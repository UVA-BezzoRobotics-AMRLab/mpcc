...
class MPCC
{
   ...
   protected:
    ...
    static double objective(const std::vector<double> &x, std::vector<double> &grad,
                            void *data);
    static double constraint(const std::vector<double> &x, std::vector<double> &grad,
                             void *data);

    static void multi_constraint(unsigned m, double *result, unsigned n, const double *x,
    ...
    // &vars, void *data);
    static autodiff::VectorXreal eval_cbf_constraint(const autodiff::VectorXreal &vars,
                                                     void *data);
