...
extern void cpg_update_Domain(cpg_int idx, cpg_float val);
extern void cpg_update_A_mat(cpg_int idx, cpg_float val);
extern void cpg_update_b_vec(cpg_int idx, cpg_float val);
