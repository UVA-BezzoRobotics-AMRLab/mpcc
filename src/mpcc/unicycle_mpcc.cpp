...
int main() {
  unicycle_model_solver_capsule* acados_ocp_capsule =
      unicycle_model_acados_create_capsule();
  ...
  int status             = unicycle_model_acados_create_with_discretization(
  ...
  ocp_nlp_config* nlp_config =
      unicycle_model_acados_get_nlp_config(acados_ocp_capsule);
  ocp_nlp_dims* nlp_dims =
      unicycle_model_acados_get_nlp_dims(acados_ocp_capsule);
  ...
  ocp_nlp_solver* nlp_solver =
      unicycle_model_acados_get_nlp_solver(acados_ocp_capsule);
